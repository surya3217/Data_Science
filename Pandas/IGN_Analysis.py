...
Code Challenge
  ...
  Problem Statement:
   ...
   1.find games released for the Xbox One that have a score of more than 7.
   2.review distribution for the Xbox One vs the review distribution for the 
     PlayStation 4. We can do this via a histogram, which will plot the frequencies
...
# reading the dataset
reviews= pd.read_csv('pd_csv/ign.csv')
